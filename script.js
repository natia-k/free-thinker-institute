...
/* =================================
   COMMUNITY EQUATION LETTER REVEAL
   ================================= */
...
/* keep the nice shimmer */
.community-equation.pastel-shimmer {
...
/* first line */
.community-equation.is-writing span:nth-of-type(1) {
  opacity: 1;
...
/* second line */
.community-equation.is-writing span:nth-of-type(2) {
  opacity: 1;
  transform: translateY(0);
  filter: blur(0);
...
.community-equation.is-writing {
  text-shadow:
    0 0 18px rgba(191, 162, 255, 0.12),
